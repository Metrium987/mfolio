...
- **Auth** : sessions signées (JWKS/JWT_PRIVATE_KEY), mot de passe haché par Convex Auth, codes OTP à durée limitée (15 min).
- **Anti-spam du formulaire de contact** : honeypot invisible, limite de fréquence par visiteur (3 messages/heure), longueurs plafonnées (nom 100, sujet 200, message 5000).
