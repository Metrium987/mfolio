...
| `settings` | Config du rendu : thème (couleur d'accent + ambiance clair/sombre/auto), GA, DeepL (write-only), visibilités, ordre, SEO, scripts perso, maintenance, layout | Public (clés masquées) |
